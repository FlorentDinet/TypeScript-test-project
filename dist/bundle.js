...
var Book = (function () {
    // CONSTRUCTEUR
    function Book(titre, resume, prix, edition, nbPag, dateRedac, ecrivains, dispoVente) {
        if (dispoVente === void 0) { dispoVente = false; }
    ...
    Object.defineProperty(Book.prototype, "$titre", {
        get: function () {
            return this.titre;
        },
        set: function (value) {
    ...
    Object.defineProperty(Book.prototype, "$resume", {
        get: function () {
            return this.resume;
        },
        set: function (value) {
    ...
    Object.defineProperty(Book.prototype, "$prix", {
        get: function () {
            return this.prix;
        },
        set: function (value) {
    ...
    Object.defineProperty(Book.prototype, "$nbPag", {
        get: function () {
            return this.nbPag;
        },
        set: function (value) {
    ...
    Object.defineProperty(Book.prototype, "$dateRedac", {
        get: function () {
    ...
    Object.defineProperty(Book.prototype, "$ecrivains", {
        get: function () {
    ...
    Object.defineProperty(Book.prototype, "$dispoVente", {
        get: function () {
    ...
    Object.defineProperty(Book.prototype, "$prixMoyen", {
        get: function () {
     ...
     */
    Book.prototype.formatterTitre = function () {
     ...
     */
    Book.prototype.calculerAgeLivre = function () {
        var dob = this.dateRedac;
        var now = new Date();
        var diff = now.valueOf() - dob.valueOf();
        var test = moment.duration(diff, 'ms');
     ...
     */
    Book.prototype.isOlderThan1970 = function () {
     ...
     * formatterPrix
     */
    Book.prototype.formatterPrix = function () {
        var prix = String(this.$prix);
     ...
     */
    Book.calculerPrixMoyen = function () {
        var total = Book.prixMoyen.reduce(function (a, b) {
            return a + b;
        }, 0);
...
},{"../../bower_components/moment/moment":1}],3:[function(require,module,exports){
"use strict";
/**
 * Commentaire
 */
var Commentaire = (function () {
    ...
    Object.defineProperty(Commentaire.prototype, "$date", {
        get: function () {
            return this.date;
        },
        enumerable: true,
    ...
    Object.defineProperty(Commentaire.prototype, "$content", {
        get: function () {
            return this.content;
        },
        set: function (value) {
    ...
    Object.defineProperty(Commentaire.prototype, "$writer", {
        get: function () {
            return this.writer;
        },
        set: function (value) {
    ...
    Object.defineProperty(Commentaire.prototype, "$produit", {
        get: function () {
            return this.produit;
        },
        set: function (value) {
...
var Humain = (function () {
    // Constructeur
    function Humain(prenom, nom, couleurYeux, couleurCheveux, taille, poids, langue, niveauLangue, sms, commentaires) {
    ...
    */
    ...
    Object.defineProperty(Humain.prototype, "$commentaires", {
        get: function () {
    ...
    */
    ...
    // Constructeur
    Humain.prototype.ecrireCommentaire = function (param) {
        param.commentaire.$writer = this.prenom + "" + this.nom;
        param.commentaire.$id = Commentaire_1.Commentaire.compteur;
    ...
    Humain.prototype.ecrireCommentaires = function (commentaires) {
        var _this = this;
        commentaires.forEach(function (commentaire) {
            _this.ecrireCommentaire(commentaire);
        });
        return this;
    };
    Humain.prototype.supprimerCommentaire = function (which) {
        if (which === void 0) { which = null; }
        if (typeof which !== 'Array') {
            alert('On attend un tableau d’id de SMS a supprimer');
            return;
    ...
    Humain.prototype.voirTitreProduit = function (id) {
...
},{"./Commentaire":3}],5:[function(require,module,exports){
"use strict";
var Humain_1 = require("./App/Humain");
var Book_1 = require('./App/Book');
...
var harryPotter = new Book_1.Book("Harry Potter", "Cillum sint amet aliqua est excepteur cupidatat aute laboris deserunt veniam non.", 1900435565.56, "Glena", 267, new Date(2013, 6, 25), [francois, florent]);
var eloquentJS = new Book_1.Book("eloquent javascript", "Anim quis ut ex cillum.", 29, "O'Reilly", 430, new Date(2016, 3, 5), [francois, florent]);
var vieuxBouquin = new Book_1.Book("Vieux Bouquin", "Exercitation reprehenderit irure eu velit minim eu esse officia esse ea voluptate.", 10, "Vieil Autheur", 650, new Date(1962, 9, 16), [francois, florent]);
console.log(harryPotter);
harryPotter.formatterTitre();
console.log(harryPotter);
console.log("Prix moyen : ", Book_1.Book.calculerPrixMoyen());
